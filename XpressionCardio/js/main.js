...
function renderDigitalTime(hour, minute, day, dateOfMonth, month, seconds) {
	...
	if (bHRON === 1) {
		...
		context.textBaseline = 'middle';
		context.font = '30px monospace';
		context.fillText(heartRate, canvas.width * 4.5 / 10,
		...
		context.fillText("bpm", canvas.width * 4.5 / 10,
		...
		for (i = 1; i <= 12; i++) {
			angle = (i - 3) * (Math.PI * 2) / 12;
			dx = clockRadiusX * 0.18 * Math.cos(angle) + canvas.width * 4.5
					/ 10;
		...
		context
				.arc(canvas.width * 4.5 / 10, canvas.height * 7 / 10,
		...
		context.arc(canvas.width * 6.6 / 10, canvas.height * 7.3 / 10,
...
//		context.textBaseline = 'middle';
//		context.font = '14px monospace';
//		context.fillText("", canvas.width * 6.6 / 10,
...
//		context.closePath();
		...
		context.fillText(heartRate, canvas.width * 6.6 / 10,
		...
		context.textBaseline = 'middle';
		context.font = '14px monospace';
		context.fillText("bpm", canvas.width * 6.6 / 10,
				canvas.height * 7.7 / 10);
		context.fill();
		context.closePath();
 ...
 * document.getElementById('menu').style.visibility = 'visible'; } } } catch
 * (err) { console.log('Error: ', err.message); }
 * 
 * }); } catch (err) { } } function onErrorCallback(error) { console.log("An
