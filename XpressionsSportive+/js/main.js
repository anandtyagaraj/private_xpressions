...
//		
//		if (lastStepFetch === 0) {
//			lastStepFetch = tizen.time.getCurrentDateTime().addDuration(
//					new tizen.TimeDuration(-1, "MSECS"));
//		}
//
//		
...
//		}
//		
//		var timeDiffSteps = now.difference(lastStepFetch);
//		
//		if (timeDiffSteps.greaterThan(new tizen.TimeDuration(1, "MINS"))) {
//			lastStepFetch = tizen.time.getCurrentDateTime().addDuration(
//					new tizen.TimeDuration(-1, "MSECS"));
//			fetchSteps();
//		}
