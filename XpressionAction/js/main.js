...
var canvas, context, clockRadiusX, clockRadiusY, battery, timeformat, colorIndex = 1, colorSec = "#28ABE1";
...
function renderDigitalTime(hour, minute, day, dateOfMonth, month, seconds) {
	...
	context.fillText(dateOfMonth + " " + sMonth, 77, 10);
	context.closePath();
...
//				var y = e.y;
//
//				var yMin = canvas.height * 2 / 10;
//				var yMax = canvas.height * 5 / 10;
//
//				var xMin = canvas.width * 3 / 10;
//				var xMax = canvas.width * 7 / 10;
//
//				if (y >= yMin && y <= yMax) {
//					if (timeformat === "0") {
//						timeformat = "1";// 24 hr
...
//				}
//
//				if (e.x >= xMin && e.x <= xMax && y >= canvas.height * 6 / 10
